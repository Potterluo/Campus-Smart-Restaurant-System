<template>
  <div class="wrapper">
    <div style="margin: 150px auto; background-color: rgba(255,255,255,0.7); width: 350px; height: 360px; padding: 20px; border-radius: 15px">
      <div style="margin: 20px 0; text-align: center; font-size: 24px"><b>注 册 页 面</b></div>
