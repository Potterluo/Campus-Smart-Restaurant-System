    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="role" label="角色" width="140">
        <template slot-scope="scope">
          ...
          <el-tag type="warning" v-if="scope.row.role === 'ROLE_STORE'">商铺成员</el-tag>
          <el-tag type="success" v-if="scope.row.role === 'ROLE_BAOJIE'">保洁人员</el-tag>
          <el-tag type="info" v-if="scope.row.role === 'ROLE_USER'">普通用户</el-tag>
          <el-tag type="primary" v-if="scope.row.role === 'ROLE_MANAGER'">餐厅管理人员</el-tag>
        </template>
      </el-table-column>
